...
const TEMPLATE_CONTEXT = {
  new_sibling: 'הסיפור עוסק בקבלת אח/אחות חדשים למשפחה ותחושות הדמות הראשית. מדגיש אהבה, קנאה בריאה, ותפקיד האח/ות הגדול.',
  birthday_child: 'הסיפור עוסק ביום הולדת מיוחד עם הפתעות, רגעים שמחים וחגיגה עם הדמויות האהובות.',
  potty_training: 'הסיפור עוסק בגמילה מחיתולים בצורה חיובית ומעצימה. גיבור הסיפור מגלה שהוא/היא כבר גדול/ה.',
  family_love: 'הסיפור מתאר קשר אהבה ומיוחד בין בני המשפחה. מלא חום, חיבוקים ורגעים שיישמרו לנצח.',
  fear_of_dark: 'הסיפור עוסק בהתגברות על פחד מהחושך. הגיבור מגלה שהחושך מסתיר דברים קסומים וצבעוניים.',
  first_day_school: 'הסיפור עוסק ביום הראשון בגן או בית הספר. הגיבור חש פחד ורגש ומגלה שזה מקום נפלא עם חברים חדשים.',
  first_haircut: 'הסיפור עוסק בחוויית התספורת הראשונה. מרגש, קצת מפחיד, ומסתיים בגאווה ועמידה חדשה.',
  lost_tooth: 'הסיפור עוסק בנפילת השן הראשונה. הרפתקה מלאת פלא, עם פיה של שיניים ורגע מיוחד של גדילה.',
  new_pet: 'הסיפור עוסק בקבלת חיית מחמד חדשה למשפחה. אחריות, אהבה, ותחילתה של ידידות מיוחדת.',
  two_homes: 'הסיפור עוסק בחיים בשני בתים אחרי גירושין. מלא אהבה, בטחון ומסר שהאהבה של ההורים אינה משתנה.',
  goodbye_pacifier: 'הסיפור עוסק בפרידה מהמוצץ. טקס מרגש של גדילה שבו הגיבור מוסר את המוצץ לתינוקות אחרים.',
  independence_day: 'הסיפור עוסק ביום העצמאות ומשמעות ארץ ישראל. מלא בגאווה ציונית, דגלים ורגעים שמחים.',
  self_confidence: 'הסיפור עוסק בבניית ביטחון עצמי ואמונה ביכולות. הגיבור מגלה את הכוחות המיוחדים שלו/ה.',
  emotional_journal: 'זהו יומן רגשי-משפחתי מעצים. כתוב עמודים של העצמה, שאלות לשיח ורגעים לזכירה.',
}
