...
const TEMPLATE_CONTEXT: Record<string, string> = {
  new_sibling: 'הסיפור עוסק בקבלת אח/אחות חדשים למשפחה ותחושות הדמות הראשית.',
  birthday_child: 'הסיפור עוסק ביום הולדת מיוחד עם הפתעות ורגעים שמחים.',
  potty_training: 'הסיפור עוסק בגמילה מחיתולים בצורה חיובית ומעצימה.',
  family_love: 'הסיפור מתאר קשר אהבה ומיוחד בין בני המשפחה.',
  fear_of_dark: 'הסיפור עוסק בהתגברות על פחד מהחושך. הגיבור מגלה שהחושך מסתיר דברים קסומים.',
  first_day_school: 'הסיפור עוסק ביום הראשון בגן/ביה"ס. הגיבור חש פחד ומגלה שזה מקום נפלא.',
  first_haircut: 'הסיפור עוסק בחוויית התספורת הראשונה. מרגש ומסתיים בגאווה.',
  lost_tooth: 'הסיפור עוסק בנפילת השן הראשונה עם פיה של שיניים ורגע של גדילה.',
  new_pet: 'הסיפור עוסק בקבלת חיית מחמד חדשה. אחריות, אהבה, וידידות מיוחדת.',
  two_homes: 'הסיפור עוסק בחיים בשני בתים אחרי גירושין. מלא אהבה ובטחון.',
  goodbye_pacifier: 'הסיפור עוסק בפרידה מהמוצץ. טקס מרגש של גדילה.',
  independence_day: 'הסיפור עוסק ביום העצמאות ומשמעות ארץ ישראל. גאווה ציונית.',
  self_confidence: 'הסיפור עוסק בבניית ביטחון עצמי. הגיבור מגלה את הכוחות המיוחדים שלו.',
  emotional_journal: 'יומן רגשי-משפחתי מעצים עם עמודי שאלות, חיזוק ורגעים לזיכרון.',
}
