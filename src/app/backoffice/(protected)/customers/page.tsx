  ...
  return (
    <div className="space-y-6">
      <section className="flex flex-col gap-2">
        ...
        <h1 className="text-4xl font-black text-[#1a1a2e]">לקוחות ו-LTV</h1>
        <p className="max-w-3xl text-sm leading-7 text-gray-600">
          כרטיסי לקוח מאוחדים עם לידים, רכישות, ספרים, טיוטות ופעילות מצטברת.
        </p>
      </section>

      <section className="overflow-hidden rounded-[1.75rem] border border-coral-100 bg-white">
        <div className="grid grid-cols-[1.2fr_0.8fr_0.7fr_0.7fr_0.8fr] gap-3 border-b border-coral-100 px-5 py-4 text-xs font-semibold uppercase tracking-[0.2em] text-coral-500">
          <span>לקוח</span>
          <span>סטטוס</span>
          <span>ספרים</span>
          <span>הזמנות</span>
        ...
        <div className="divide-y divide-coral-100">
          {customers.map((customer) => (
            <Link
              ...
              className="grid grid-cols-[1.2fr_0.8fr_0.7fr_0.7fr_0.8fr] gap-3 px-5 py-4 transition hover:bg-[#FFF9F0]"
            >
              <div>
