...
const SECTIONS = [
  ...
  },
  {
    title: 'השירות',
    body:
      'האתר מאפשר יצירה והזמנה של ספרים מותאמים אישית על בסיס מידע, טקסטים, תמונות ופרטים שמוזנים על ידי המשתמשים. אנו עושים מאמץ לספק תוצאה איכותית, אך ייתכנו הבדלים בין הציפייה לבין התוצר הסופי בשל אופי היצירה המותאמת.',
  },
  {
  ...
  {
    title: 'תמונות ותוכן שנוצרים באמצעות AI',
    body:
      'המערכת עושה שימוש בכלי בינה מלאכותית לצורך יצירת טקסטים, איורים ותמונות. התוצרים נוצרים באופן אוטומטי ועלולים לכלול שגיאות, אי-דיוקים, חוסר התאמה לציפיות או מאפיינים בלתי צפויים. מובהר כי אין לנו אחריות לתמונות, לאיורים או לתוצרים הוויזואליים שנוצרים במערכת, לרבות התאמתם המלאה לבקשת המשתמש, לדמיון המבוקש או לכל שימוש שייעשה בהם לאחר מכן.',
  },
  {
    title: 'תשלום והזמנות',
    body:
  ...
  },
  {
    title: 'הגבלת אחריות',
    body:
      'השירות ניתן כפי שהוא ובהתאם לזמינותו. אנו עושים מאמצים לשמור על פעילות תקינה של האתר, אך איננו מתחייבים כי השירות יהיה זמין ללא הפרעות או נקי משגיאות בכל עת. בכל מקרה, האחריות לבדיקה הסופית של התוכן, הטקסטים והתמונות לפני שימוש, שיתוף או הדפסה חלה על המשתמש.',
  },
  {
    title: 'יצירת קשר',
    body:
      'לכל שאלה, בירור או פנייה בנוגע לשימוש באתר ניתן לפנות דרך עמוד צור קשר. מומלץ גם להתאים את תנאי השימוש לייעוץ משפטי פרטני בהתאם לאופי הפעילות העסקית בפועל.',
  },
]
    ...
    <main className="min-h-dvh bg-[#FFF9F0] text-gray-900">
      <section className="border-b border-coral-100/80 bg-[linear-gradient(180deg,#FFF9F0_0%,#FFF4E6_100%)]">
        <div className="mx-auto max-w-5xl px-4 py-14 md:px-8 md:py-20">
          <h1 className="mt-5 text-4xl font-black leading-[1.05] text-[#1a1a2e] md:text-6xl">תנאי השימוש באתר</h1>
